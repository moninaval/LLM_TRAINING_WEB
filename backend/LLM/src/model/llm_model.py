...
class LLMModel(nn.Module):
    def __init__(self, vocab_size, hidden_size, num_layers, num_heads, intermediate_size,
                 ...
                 norm_type="layernorm", ffn_type="gelu", qkv_proj="fused", tie_weights=False, debug=False,log_everything=False,log_chunk=256):
        super().__init__()
        ...
        self.token_embedding = TokenEmbedding(
            ...
            use_rotary=use_rotary,log_everything=log_everything
        )
